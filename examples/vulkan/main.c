...
void move_player(ZEN_Window* window, size_t player_object) {
    ...
    ZEN_RenderObject* player = zen_get_render_object(player_object);
...
int main(int argc, char** argv) {
    ...
    size_t square_1 = draw_square((vec3){.0f,.0f,.0f}, (vec3){200.0f,200.0f,.0f}, (vec4){.0f,.0f,0.0f,.0f}, default_shader);
